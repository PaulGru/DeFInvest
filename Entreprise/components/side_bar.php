  ...
  <nav class="side-nav">
    <div class="wrapper">
      ...
      <div class="nav-bloc n-1">
        ...
        <div class="sub-nav">
          ...
          <ul>
            ...
            <li>
              <a href="livret.php">Livret</a>
            </li>
            <li>
              <a href="lending.php">Lending</a>
            </li>
            <li>
              <a href="staking.php">Staking</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="nav-bloc n-2">
        ...
        <div class="sub-nav">
          <h2>Esp. Utilisateur</h2>
          <ul>
            <li>
              <a href="../bdd/signin_form.php">Créer son compte</a>
            </li>
            <li>
              <a href="../bdd/login_form.php">Connexion</a>
            </li>
            <li>
              <a href="../product/wallet.php">Vos fonds</a>
            </li>
          </ul>
        </div>
      </div>
